...
// con datos reales del partido, nada fijo/decorativo (el nombre del
// equipo reemplaza al código de 3 letras de la referencia, que acá no
// existe como dato).
      ...
      <div className="pfb-caja">
        <div className="pfb-fila-principal">
          <div className="pfb-equipo pfb-local" style={{ background: partido.equipoLocal.color }}>
            ...
            <span className="pfb-nombre">{partido.equipoLocal.nombre}</span>
          </div>
          ...
          <div className="pfb-equipo pfb-visita" style={{ background: partido.equipoVisita.color }}>
            <span className="pfb-nombre">{partido.equipoVisita.nombre}</span>
