    ...
    <div className="plantilla-marcador pcs-wrap" style={estiloPersonalizado(config)}>
      <div className="pcs-columna">
        <div className="pcs-tarjeta" style={{ borderLeftColor: partido.equipoLocal.color }}>
          ...
          <span className="pcs-nombre">{partido.equipoLocal.nombre}{mostrar(config, 'mostrarFaltas') ? ` · F${indicadorFaltas(partido.faltasLocal, config?.estiloFaltas)}` : ''}</span>
        ...
        <div className="pcs-tarjeta" style={{ borderLeftColor: partido.equipoVisita.color }}>
          ...
          <span className="pcs-nombre">{partido.equipoVisita.nombre}{mostrar(config, 'mostrarFaltas') ? ` · F${indicadorFaltas(partido.faltasVisita, config?.estiloFaltas)}` : ''}</span>
